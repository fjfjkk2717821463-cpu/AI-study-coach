...
.venv\Scripts\python -m PyInstaller --noconfirm --clean --onefile --windowed --name "DFL Coach" --add-data "templates;templates" --add-data "static;static" --collect-all webview --distpath "打包产物\app" --workpath "打包产物\build" --specpath "打包产物" desktop.py
