...
.venv\Scripts\python -m PyInstaller --noconfirm --clean --onefile --windowed --name "DFL Coach" --collect-all webview --distpath "打包产物\app" --workpath "打包产物\build" --specpath "打包产物" desktop.py
